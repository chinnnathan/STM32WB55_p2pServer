...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : SN_3A_Pin SN_4A_Pin SN_34E_Pin SN_12E_Pin */
  GPIO_InitStruct.Pin = SN_3A_Pin|SN_4A_Pin|SN_34E_Pin|SN_12E_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : SN_1A_Pin SN_2A_Pin */
  GPIO_InitStruct.Pin = SN_1A_Pin|SN_2A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
